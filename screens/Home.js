  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <ImageBackground
          source={require('../assets/nomeDoArquivoDeFundo')}
          resizeMode="cover"
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate('Telaasernavegada')}>
            <Text style={styles.routeText}>Localização da EEI</Text>
            <Text style={styles.knowMore}>{'Saber mais --->'}</Text>
            <Image
              source={require('../assets/nomeDoArquivoDeIss')}
          ...
          <TouchableOpacity style={styles.routeCard}>
            ...
            <Text style={styles.knowMore}>{'Saber mais --->'}</Text>
            <Image
              source={require('../assets/nomeDoArquivoDeMeteoro')}
              style={styles.iconImage}></Image>
          </TouchableOpacity>
          <TouchableOpacity style={styles.routeCard}>
            ...
            <Text style={styles.knowMore}>{'Saber mais --->'}</Text>
            <Image
              source={require('../assets/nomeDoArquivoDeAtualizacao')}
              style={styles.iconImage}></Image>
          </TouchableOpacity>
        </ImageBackground>
      </View>
